...
import ItemsSubDomain from "./Components/ItemsSubDomain/ItemsSubDomain";

export default function PaginatedSubDomains(props){
    ...
    return (
        <>
            ...
            {isLoad && (
                ...
                <>
                    <ItemsSubDomain currentItems={currentItems}/>
